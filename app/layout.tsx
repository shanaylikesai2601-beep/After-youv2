...
try {
  console.log('[layout] module loaded, VERCEL=', !!process.env.VERCEL, 'CWD=', process.cwd());
} catch (e) {
  console.error('[layout] module init error:', e);
}
...
const Layout = ({ children }: { children: React.ReactNode }) => {
  try {
    ...
    return (
      <html lang="en">
        <body><h1>Something went wrong</h1><pre>{String(e)}</pre></body>
      </html>
    );
  }
};
